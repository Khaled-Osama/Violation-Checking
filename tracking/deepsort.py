...
class deepsort_rbc():
	def __init__(self,wt_path, device):
		...
		self.tracker= Tracker(self.metric, n_init=15, max_iou_distance=0.7, max_age=20)
	...
	def run_deep_sort(self, frame, out_scores, out_boxes, types):
		...
		dets = [Detection(bbox, score, t, feature) \
					for bbox,score, t, feature in\
				zip(detections,out_scores, types, features)]
